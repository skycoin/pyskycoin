...
def SKY_params_GetDistributionAddressesDecoded():
    return _skycoin.SKY_params_GetDistributionAddressesDecoded()
SKY_params_GetDistributionAddressesDecoded = _skycoin.SKY_params_GetDistributionAddressesDecoded

def SKY_params_GetUnlockedDistributionAddressesDecoded():
    return _skycoin.SKY_params_GetUnlockedDistributionAddressesDecoded()
SKY_params_GetUnlockedDistributionAddressesDecoded = _skycoin.SKY_params_GetUnlockedDistributionAddressesDecoded

def SKY_params_GetLockedDistributionAddressesDecoded():
    return _skycoin.SKY_params_GetLockedDistributionAddressesDecoded()
SKY_params_GetLockedDistributionAddressesDecoded = _skycoin.SKY_params_GetLockedDistributionAddressesDecoded
...
def SKY_wallet_ResolveCoinType(p0):
    return _skycoin.SKY_wallet_ResolveCoinType(p0)
SKY_wallet_ResolveCoinType = _skycoin.SKY_wallet_ResolveCoinType

def SKY_wallet_NewWalletFilename():
    return _skycoin.SKY_wallet_NewWalletFilename()
SKY_wallet_NewWalletFilename = _skycoin.SKY_wallet_NewWalletFilename

def SKY_wallet_Wallet_Erase(p0):
    return _skycoin.SKY_wallet_Wallet_Erase(p0)
SKY_wallet_Wallet_Erase = _skycoin.SKY_wallet_Wallet_Erase

def SKY_wallet_Wallet_GetAddress(p0):
    return _skycoin.SKY_wallet_Wallet_GetAddress(p0)
SKY_wallet_Wallet_GetAddress = _skycoin.SKY_wallet_Wallet_GetAddress

def SKY_wallet_Wallet_GetSkycoinAddresses(p0):
    return _skycoin.SKY_wallet_Wallet_GetSkycoinAddresses(p0)
SKY_wallet_Wallet_GetSkycoinAddresses = _skycoin.SKY_wallet_Wallet_GetSkycoinAddresses

def SKY_wallet_Wallet_CreateAndSignTransaction(p0, p1, p2, p3, p4, p5):
    return _skycoin.SKY_wallet_Wallet_CreateAndSignTransaction(p0, p1, p2, p3, p4, p5)
SKY_wallet_Wallet_CreateAndSignTransaction = _skycoin.SKY_wallet_Wallet_CreateAndSignTransaction

def SKY_wallet_Wallet_CreateAndSignTransactionAdvanced(p0, p1, p2, p3, p4):
    return _skycoin.SKY_wallet_Wallet_CreateAndSignTransactionAdvanced(p0, p1, p2, p3, p4)
SKY_wallet_Wallet_CreateAndSignTransactionAdvanced = _skycoin.SKY_wallet_Wallet_CreateAndSignTransactionAdvanced
...
def SKY_coin_MultUint64(p0, p1):
    return _skycoin.SKY_coin_MultUint64(p0, p1)
SKY_coin_MultUint64 = _skycoin.SKY_coin_MultUint64
...
def SKY_cipher_BitcoinPubKeyRipemd160(p0, p1):
    return _skycoin.SKY_cipher_BitcoinPubKeyRipemd160(p0, p1)
SKY_cipher_BitcoinPubKeyRipemd160 = _skycoin.SKY_cipher_BitcoinPubKeyRipemd160
...
def SKY_cipher_Ripemd160FromBytes(p0, p1):
    return _skycoin.SKY_cipher_Ripemd160FromBytes(p0, p1)
SKY_cipher_Ripemd160FromBytes = _skycoin.SKY_cipher_Ripemd160FromBytes
...
def SKY_cipher_SHA256FromBytes(p0, p1):
    return _skycoin.SKY_cipher_SHA256FromBytes(p0, p1)
SKY_cipher_SHA256FromBytes = _skycoin.SKY_cipher_SHA256FromBytes
...
def SKY_wallet_Entry_SkycoinAddress(p0, p1):
    return _skycoin.SKY_wallet_Entry_SkycoinAddress(p0, p1)
SKY_wallet_Entry_SkycoinAddress = _skycoin.SKY_wallet_Entry_SkycoinAddress

def SKY_wallet_Entry_BitcoinAddress(p0, p1):
    return _skycoin.SKY_wallet_Entry_BitcoinAddress(p0, p1)
SKY_wallet_Entry_BitcoinAddress = _skycoin.SKY_wallet_Entry_BitcoinAddress
...
def SKY_api_Client_RecoverWallet(p0, p1, p2, p3):
    return _skycoin.SKY_api_Client_RecoverWallet(p0, p1, p2, p3)
SKY_api_Client_RecoverWallet = _skycoin.SKY_api_Client_RecoverWallet

def SKY_api_Client_Disconnect(p0, p1):
    return _skycoin.SKY_api_Client_Disconnect(p0, p1)
SKY_api_Client_Disconnect = _skycoin.SKY_api_Client_Disconnect
...
def SKY_httphelper_SHA256_UnmarshalJSON(p0, p1):
    return _skycoin.SKY_httphelper_SHA256_UnmarshalJSON(p0, p1)
SKY_httphelper_SHA256_UnmarshalJSON = _skycoin.SKY_httphelper_SHA256_UnmarshalJSON

def SKY_httphelper_SHA256_MarshalJSON(p0):
    return _skycoin.SKY_httphelper_SHA256_MarshalJSON(p0)
SKY_httphelper_SHA256_MarshalJSON = _skycoin.SKY_httphelper_SHA256_MarshalJSON
