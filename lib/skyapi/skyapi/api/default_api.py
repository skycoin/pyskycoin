...
class DefaultApi(object):
    ...
    def transaction(self, txid, **kwargs):  # noqa: E501
        ...
        Returns a transaction identi`fied by its txid hash with just id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def wallet_spent_with_http_info(self, id, dst, coins, password, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `wallet_spent`")  # noqa: E501
        # verify the required parameter 'dst' is set
        if ('dst' not in local_var_params or
                local_var_params['dst'] is None):
            raise ApiValueError("Missing the required parameter `dst` when calling `wallet_spent`")  # noqa: E501
        # verify the required parameter 'coins' is set
        if ('coins' not in local_var_params or
                local_var_params['coins'] is None):
            raise ApiValueError("Missing the required parameter `coins` when calling `wallet_spent`")  # noqa: E501
        # verify the required parameter 'password' is set
        if ('password' not in local_var_params or
                local_var_params['password'] is None):
            raise ApiValueError("Missing the required parameter `password` when calling `wallet_spent`")  # noqa: E501
    ...
    def wallet_transaction(self, body, **kwargs):  # noqa: E501
        """wallet_transaction  # noqa: E501

        Creates a signed transaction  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wallet_transaction(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.wallet_transaction_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.wallet_transaction_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def wallet_transaction_with_http_info(self, body, **kwargs):  # noqa: E501
        """wallet_transaction  # noqa: E501

        Creates a signed transaction  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wallet_transaction_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `body` when calling `wallet_transaction`")  # noqa: E501
