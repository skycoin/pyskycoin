...
class DefaultApi(object):
    ...
    def block_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[BlockSchema], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def network_connection_with_http_info(self, addr, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(NetworkConnectionSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def transaction_inject(self, rawtx, **kwargs):  # noqa: E501
        ...
        :param bool no_broadcast: Disable the network broadcast
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def transaction_inject_with_http_info(self, rawtx, **kwargs):  # noqa: E501
        ...
        all_params = ['rawtx', 'no_broadcast']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'no_broadcast' in local_var_params:
            header_params['no_broadcast'] = local_var_params['no_broadcast']  # noqa: E501
    ...
    def wallet_create(self, type, seed, label, **kwargs):  # noqa: E501
        """wallet_create  # noqa: E501

        Create a wallet  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wallet_create(type, seed, label, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str type: wallet seed passphrase [optional, bip44 type wallet only] (required)
        :param str seed: Wallet seed. (required)
        :param str label: Wallet label. (required)
        :param str seed_passphrase: wallet seed passphrase [optional, bip44 type wallet only]
        :param str bip44_coin: BIP44 coin type [optional, defaults to 8000 (skycoin's coin type), only valid if type is \"bip44\"]
        :param str xpub: xpub key [required for xpub wallets]
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.wallet_create_with_http_info(type, seed, label, **kwargs)  # noqa: E501

    def wallet_create_with_http_info(self, type, seed, label, **kwargs):  # noqa: E501
        """wallet_create  # noqa: E501

        Create a wallet  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wallet_create_with_http_info(type, seed, label, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['type', 'seed', 'label', 'seed_passphrase', 'bip44_coin', 'xpub', 'scan', 'encrypt', 'password']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('type' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `type` when calling `wallet_create`")  # noqa: E501
        ...
        header_params = {}
        if 'seed_passphrase' in local_var_params:
            header_params['seed-passphrase'] = local_var_params['seed_passphrase']  # noqa: E501
        if 'type' in local_var_params:
            header_params['type'] = local_var_params['type']  # noqa: E501
        if 'bip44_coin' in local_var_params:
            header_params['bip44-coin'] = local_var_params['bip44_coin']  # noqa: E501
        if 'seed' in local_var_params:
            header_params['seed'] = local_var_params['seed']  # noqa: E501
        if 'xpub' in local_var_params:
            header_params['xpub'] = local_var_params['xpub']  # noqa: E501
    ...
    def wallet_recover(self, id, seed, **kwargs):  # noqa: E501
        ...
        Recovers an encrypted wallet by providing the wallet seed and optional seed passphrase  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str id: Wallet id. (required)
        :param str seed: Wallet seed. (required)
        :param str seed_passphrase: Wallet seed-passphrase.
        :param str password: Wallet password.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def wallet_recover_with_http_info(self, id, seed, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'seed', 'seed_passphrase', 'password']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
