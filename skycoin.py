...
def SKY_wallet_LoadReadableEntry(p0, p1):
    return _skycoin.SKY_wallet_LoadReadableEntry(p0, p1)
SKY_wallet_LoadReadableEntry = _skycoin.SKY_wallet_LoadReadableEntry

def SKY_wallet_NewReadableEntryFromPubkey(p0, p1):
    return _skycoin.SKY_wallet_NewReadableEntryFromPubkey(p0, p1)
...
def SKY_wallet_LoadReadableWallet(p0, p1):
    return _skycoin.SKY_wallet_LoadReadableWallet(p0, p1)
...
def SKY_api_NewWalletResponse(p0, p1):
    return _skycoin.SKY_api_NewWalletResponse(p0, p1)
...
def SKY_api_NewClient(p0, p1):
    return _skycoin.SKY_api_NewClient(p0, p1)
...
def SKY_api_Client_Version(p0, p1):
    return _skycoin.SKY_api_Client_Version(p0, p1)
SKY_api_Client_Version = _skycoin.SKY_api_Client_Version

def SKY_api_Client_Outputs(p0, p1):
    return _skycoin.SKY_api_Client_Outputs(p0, p1)
SKY_api_Client_Outputs = _skycoin.SKY_api_Client_Outputs

def SKY_api_Client_OutputsForAddresses(p0, p1, p2):
    return _skycoin.SKY_api_Client_OutputsForAddresses(p0, p1, p2)
SKY_api_Client_OutputsForAddresses = _skycoin.SKY_api_Client_OutputsForAddresses

def SKY_api_Client_OutputsForHashes(p0, p1, p2):
    return _skycoin.SKY_api_Client_OutputsForHashes(p0, p1, p2)
SKY_api_Client_OutputsForHashes = _skycoin.SKY_api_Client_OutputsForHashes

def SKY_api_Client_CoinSupply(p0, p1):
    return _skycoin.SKY_api_Client_CoinSupply(p0, p1)
SKY_api_Client_CoinSupply = _skycoin.SKY_api_Client_CoinSupply

def SKY_api_Client_BlockByHash(p0, p1, p2):
    return _skycoin.SKY_api_Client_BlockByHash(p0, p1, p2)
SKY_api_Client_BlockByHash = _skycoin.SKY_api_Client_BlockByHash

def SKY_api_Client_BlockBySeq(p0, p1, p2):
    return _skycoin.SKY_api_Client_BlockBySeq(p0, p1, p2)
SKY_api_Client_BlockBySeq = _skycoin.SKY_api_Client_BlockBySeq

def SKY_api_Client_Blocks(p0, p1, p2, p3):
    return _skycoin.SKY_api_Client_Blocks(p0, p1, p2, p3)
SKY_api_Client_Blocks = _skycoin.SKY_api_Client_Blocks

def SKY_api_Client_LastBlocks(p0, p1, p2):
    return _skycoin.SKY_api_Client_LastBlocks(p0, p1, p2)
SKY_api_Client_LastBlocks = _skycoin.SKY_api_Client_LastBlocks

def SKY_api_Client_BlockchainMetadata(p0, p1):
    return _skycoin.SKY_api_Client_BlockchainMetadata(p0, p1)
SKY_api_Client_BlockchainMetadata = _skycoin.SKY_api_Client_BlockchainMetadata

def SKY_api_Client_BlockchainProgress(p0, p1):
    return _skycoin.SKY_api_Client_BlockchainProgress(p0, p1)
...
def SKY_api_Client_UxOut(p0, p1, p2):
    return _skycoin.SKY_api_Client_UxOut(p0, p1, p2)
SKY_api_Client_UxOut = _skycoin.SKY_api_Client_UxOut

def SKY_api_Client_AddressUxOuts(p0, p1, p2):
    return _skycoin.SKY_api_Client_AddressUxOuts(p0, p1, p2)
SKY_api_Client_AddressUxOuts = _skycoin.SKY_api_Client_AddressUxOuts

def SKY_api_Client_Wallet(p0, p1, p2):
    return _skycoin.SKY_api_Client_Wallet(p0, p1, p2)
SKY_api_Client_Wallet = _skycoin.SKY_api_Client_Wallet

def SKY_api_Client_Wallets(p0, p1):
    return _skycoin.SKY_api_Client_Wallets(p0, p1)
SKY_api_Client_Wallets = _skycoin.SKY_api_Client_Wallets

def SKY_api_Client_CreateUnencryptedWallet(p0, p1, p2, p3, p4):
    return _skycoin.SKY_api_Client_CreateUnencryptedWallet(p0, p1, p2, p3, p4)
SKY_api_Client_CreateUnencryptedWallet = _skycoin.SKY_api_Client_CreateUnencryptedWallet

def SKY_api_Client_CreateEncryptedWallet(p0, p1, p2, p3, p4, p5):
    return _skycoin.SKY_api_Client_CreateEncryptedWallet(p0, p1, p2, p3, p4, p5)
...
def SKY_api_Client_CreateTransaction(p0, p1, p2):
    return _skycoin.SKY_api_Client_CreateTransaction(p0, p1, p2)
SKY_api_Client_CreateTransaction = _skycoin.SKY_api_Client_CreateTransaction

def SKY_api_Client_WalletTransactions(p0, p1, p2):
    return _skycoin.SKY_api_Client_WalletTransactions(p0, p1, p2)
...
def SKY_api_Client_WalletFolderName(p0, p1):
    return _skycoin.SKY_api_Client_WalletFolderName(p0, p1)
...
def SKY_api_Client_NetworkConnection(p0, p1, p2):
    return _skycoin.SKY_api_Client_NetworkConnection(p0, p1, p2)
...
def SKY_api_Client_NetworkDefaultConnections(p0, p1):
    return _skycoin.SKY_api_Client_NetworkDefaultConnections(p0, p1)
SKY_api_Client_NetworkDefaultConnections = _skycoin.SKY_api_Client_NetworkDefaultConnections

def SKY_api_Client_NetworkTrustedConnections(p0, p1):
    return _skycoin.SKY_api_Client_NetworkTrustedConnections(p0, p1)
SKY_api_Client_NetworkTrustedConnections = _skycoin.SKY_api_Client_NetworkTrustedConnections

def SKY_api_Client_NetworkExchangeableConnections(p0, p1):
    return _skycoin.SKY_api_Client_NetworkExchangeableConnections(p0, p1)
SKY_api_Client_NetworkExchangeableConnections = _skycoin.SKY_api_Client_NetworkExchangeableConnections

def SKY_api_Client_PendingTransactions(p0, p1):
    return _skycoin.SKY_api_Client_PendingTransactions(p0, p1)
SKY_api_Client_PendingTransactions = _skycoin.SKY_api_Client_PendingTransactions

def SKY_api_Client_Transaction(p0, p1, p2):
    return _skycoin.SKY_api_Client_Transaction(p0, p1, p2)
SKY_api_Client_Transaction = _skycoin.SKY_api_Client_Transaction

def SKY_api_Client_Transactions(p0, p1, p2):
    return _skycoin.SKY_api_Client_Transactions(p0, p1, p2)
SKY_api_Client_Transactions = _skycoin.SKY_api_Client_Transactions

def SKY_api_Client_ConfirmedTransactions(p0, p1, p2):
    return _skycoin.SKY_api_Client_ConfirmedTransactions(p0, p1, p2)
SKY_api_Client_ConfirmedTransactions = _skycoin.SKY_api_Client_ConfirmedTransactions

def SKY_api_Client_UnconfirmedTransactions(p0, p1, p2):
    return _skycoin.SKY_api_Client_UnconfirmedTransactions(p0, p1, p2)
...
def SKY_api_Client_ResendUnconfirmedTransactions(p0, p1):
    return _skycoin.SKY_api_Client_ResendUnconfirmedTransactions(p0, p1)
...
def SKY_api_Client_AddressTransactions(p0, p1, p2):
    return _skycoin.SKY_api_Client_AddressTransactions(p0, p1, p2)
SKY_api_Client_AddressTransactions = _skycoin.SKY_api_Client_AddressTransactions

def SKY_api_Client_Richlist(p0, p1, p2):
    return _skycoin.SKY_api_Client_Richlist(p0, p1, p2)
...
def SKY_api_Client_Health(p0, p1):
    return _skycoin.SKY_api_Client_Health(p0, p1)
SKY_api_Client_Health = _skycoin.SKY_api_Client_Health

def SKY_api_Client_EncryptWallet(p0, p1, p2, p3):
    return _skycoin.SKY_api_Client_EncryptWallet(p0, p1, p2, p3)
SKY_api_Client_EncryptWallet = _skycoin.SKY_api_Client_EncryptWallet

def SKY_api_Client_DecryptWallet(p0, p1, p2, p3):
    return _skycoin.SKY_api_Client_DecryptWallet(p0, p1, p2, p3)
...
def SKY_Handle_Blocks_GetAt(p0, p1, p2):
    return _skycoin.SKY_Handle_Blocks_GetAt(p0, p1, p2)
...
def SKY_api_Handle_WalletsResponseGetAt(p0, p1, p2):
    return _skycoin.SKY_api_Handle_WalletsResponseGetAt(p0, p1, p2)
...
def SKY_cli_LoadConfig(p0):
    return _skycoin.SKY_cli_LoadConfig(p0)
...
def SKY_cli_NewApp(p0, p1):
    return _skycoin.SKY_cli_NewApp(p0, p1)
SKY_cli_NewApp = _skycoin.SKY_cli_NewApp

def SKY_cli_RPCClientFromContext(p0, p1):
    return _skycoin.SKY_cli_RPCClientFromContext(p0, p1)
SKY_cli_RPCClientFromContext = _skycoin.SKY_cli_RPCClientFromContext

def SKY_cli_ConfigFromContext(p0, p1):
    return _skycoin.SKY_cli_ConfigFromContext(p0, p1)
...
def SKY_wallet_NewWallet(p0, p1, p2):
    return _skycoin.SKY_wallet_NewWallet(p0, p1, p2)
...
def SKY_wallet_Wallet_Unlock(p0, p1, p2):
    return _skycoin.SKY_wallet_Wallet_Unlock(p0, p1, p2)
SKY_wallet_Wallet_Unlock = _skycoin.SKY_wallet_Wallet_Unlock

def SKY_wallet_Load(p0, p1):
    return _skycoin.SKY_wallet_Load(p0, p1)
...
def SKY_cli_RPCClientFromApp(p0, p1):
    return _skycoin.SKY_cli_RPCClientFromApp(p0, p1)
...
def SKY_webrpc_NewClient(p0, p1):
    return _skycoin.SKY_webrpc_NewClient(p0, p1)
...
def SKY_wallet_CreateAddresses(p0, p1, p2, p3, p4):
    return _skycoin.SKY_wallet_CreateAddresses(p0, p1, p2, p3, p4)
SKY_wallet_CreateAddresses = _skycoin.SKY_wallet_CreateAddresses

def SKY_wallet_GetSkycoinWalletEntry(p0, p1, p2):
    return _skycoin.SKY_wallet_GetSkycoinWalletEntry(p0, p1, p2)
SKY_wallet_GetSkycoinWalletEntry = _skycoin.SKY_wallet_GetSkycoinWalletEntry

def SKY_wallet_GetBitcoinWalletEntry(p0, p1, p2):
    return _skycoin.SKY_wallet_GetBitcoinWalletEntry(p0, p1, p2)
...
def SKY_cli_GenerateWallet(p0, p1, p2, p3):
    return _skycoin.SKY_cli_GenerateWallet(p0, p1, p2, p3)
...
def SKY_wallet_CreateOptionsHandle(p0, p1, p2, p3, p4, p5, p6, p7):
    return _skycoin.SKY_wallet_CreateOptionsHandle(p0, p1, p2, p3, p4, p5, p6, p7)
